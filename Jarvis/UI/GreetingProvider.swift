...
/// from a curated library — film quotes, one-liners, Jarvis-butler banter,
...
enum GreetingProvider {
    ...
    ///  • Jarvis-canonical Tony Stark banter
    ...
    static let all: [String] = [
        ...
        // 41–70 — Bond
        "Bond. James Bond. …men i aften er jeg Jarvis.",
