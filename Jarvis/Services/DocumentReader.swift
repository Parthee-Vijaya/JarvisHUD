...
struct DocumentReader {
    ...
    enum ReaderError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .unsupportedType(let ext): return "Jarvis kan ikke læse .\(ext)-filer endnu."
...
enum DocumentPicker {
    ...
    static func pickDocument() -> URL? {
        ...
        panel.message = "Jarvis understøtter .pdf, .docx, .txt, .md og de fleste kildetekst-formater."
